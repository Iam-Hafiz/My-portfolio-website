...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-gray-100 max-w-6xl border border-black/5 rounded-lg overflow-hidden relative hover:bg-gray-200 transition dark:text-gray-200  dark:bg-white/10 dark:hover:bg-white/20">
        <div className="p-4 sm:max-w-[100%] flex flex-col h-full">
          ...
          <p className="mt-2 mb-2 leading-relaxed">
            ...
            <a
              href={siteUrl}
              target="_blank"
              className=" text-blue-700 dark:text-blue-500 hover:text-violet-600 underline"
            >
